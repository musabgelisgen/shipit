...
public class PackageRepository {
    ...
    public List<Map<String, Object>> getTopSenders(){
        List<Map<String, Object>> customers = jdbcTemplate.queryForList("SELECT sender_id, COUNT(package_id) AS total_packages FROM PackagePreview GROUP BY sender_id ORDER BY total_packages DESC");
